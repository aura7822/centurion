...
private:
    ...
    void handleIdentify (const httplib::Request& req, httplib::Response& res);
    void handleEnroll   (const httplib::Request& req, httplib::Response& res);
    void handleLogs     (const httplib::Request& req, httplib::Response& res);
    void handleIoT      (const httplib::Request& req, httplib::Response& res);
